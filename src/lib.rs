// src/lib.rs
/*
 * Core library for MangaNavigator
 */
...
#[derive(Debug)]
pub struct MangaNavigatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MangaNavigatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MangaNavigator processing");
    
    let mut processor = MangaNavigatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MangaNavigatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MangaNavigatorProcessor::new(false);
